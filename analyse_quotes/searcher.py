...
csv_path = os.path.join(config.current_dir, "data", csv_file)

df = pd.read_csv(csv_path, index_col=None)

heroes_txt_path = os.path.join(config.current_dir, "input_files", 'heroes.txt')
words_txt_path = os.path.join(config.current_dir, "input_files", 'words.txt')
